...
### Detailed example using sample/simulated data
- Show off modeling options here -- goal is to demonstrate user's ability to make `mxnorm` flexible.

### Analysis example using Julia's data
- Show off robustness to real data here -- goal is to demonstrate using real-world data in `mxnorm`.
