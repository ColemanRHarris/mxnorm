...
Using the above normalized data, we can run an Otsu agreement score analysis to determine how well our normalization method performs (here, we look for lower agreement scores to distinguish better performing methods):
```{r otsu}
